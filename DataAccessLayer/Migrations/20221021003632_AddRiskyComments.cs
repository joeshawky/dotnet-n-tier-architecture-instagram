...
{
    public partial class AddRiskyComments : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    RiskyCommentId = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RiskyComments", x => x.RiskyCommentId);
                    table.ForeignKey(
