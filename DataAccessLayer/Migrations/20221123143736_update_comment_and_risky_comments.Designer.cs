...
namespace DataAccessLayer.Migrations
{
    ...
    [Migration("20221123143736_update_comment_and_risky_comments")]
    partial class update_comment_and_risky_comments
    {
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Comment", b =>
                {
                    ...
                    b.HasIndex("RiskyCommentId")
                        .IsUnique()
                        .HasFilter("[RiskyCommentId] IS NOT NULL");
            ...
            modelBuilder.Entity("EntityLayer.Concrete.Comment", b =>
                {
                    ...
                    b.HasOne("EntityLayer.Concrete.RiskyComment", "RiskyComment")
                        .WithOne("Comment")
                        .HasForeignKey("EntityLayer.Concrete.Comment", "RiskyCommentId");
